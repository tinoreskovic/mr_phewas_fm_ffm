...
merge_cmd='out_file="assoc.fat_free_mass_37.regenie.merged.txt"
     cp /mnt/project/path/to/regenie_ukb_unfolded/assoc_37.*fat_free_mass.regenie.gz .
     gunzip *.regenie.gz
...
dx run swiss-army-knife -iin="${data_file_dir}/assoc_37.c1_fat_free_mass.regenie.gz" \
